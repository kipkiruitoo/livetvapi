...
<head>
    ...
    <meta name="description"
        content="Exergyent Free Live Sports Stream live | {{ $game->team1 }} vs {{ $game->team2 }}, live tv , Exergyent live today s matches , watch live matches on Exergyent life or Exergyent live " />
    <meta name="robots" content="follow, index" />
    <link rel="canonical" href="https://live.exergyents.xyz/" />
    <meta property="og:locale" content="en_EN" />
    <meta property="og:type" content="website" />
    <meta property="og:title"
        content=" Exergyent Tv - Free Live Sports Stream {{ $game->team1 }} vs {{ $game->team2 }}  " />
...
<body class="antialiased">
    <div
        class="relative  min-h-screen min-w-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        <div class="flex justify-center max-w-8xl mx-auto  lg:p-8">
            <img src="{{ $game->team1icon }}" alt="{{ $game->team1 }}"> <span class="text:black dark:text-white p-6">
        ...
        <div class="p-6 rounded">
            <iframe style="height: 80vh" id="viewFrame" allowfullscreen="allowfullscreen" loading="lazy" allow="autoplay"
                scrolling="no" width="100%" height="100%" src="{{ $game->streams[0] }}" frameborder="0"></iframe>
        </div>
