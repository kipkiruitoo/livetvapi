...
<head>
    ...
    <title>Exergyent Free Live Premier Leauge Streaming</title>
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <svg version="1.1" id="Laag_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1847.7 1849"
                    style="enable-background:new 0 0 1847.7 1849;" xml:space="preserve">
                    <style type="text/css">
                        .st0 {
                            fill: #3B2050;
                        }
                    ...
                    <path class="st0"
                        d="M923.8,0c508.6,0,923.8,415.2,923.8,925.2c1.4,511.3-415.2,923.8-929.2,923.8C413.9,1849,0,1432.4,0,923.8
                   ...
                   c-120.4-555.9-746.6-837.3-1245.7-564c-6.8,4.1-14.9,8.1-25.7,13.5C493.7,159.6,497.8,140.7,503.2,117.7L503.2,117.7z" />
                    <path class="st1"
                        d="M504.5,117.7c-5.4,23-9.5,41.9-14.9,66.3c10.8-5.4,18.9-9.5,25.7-13.5c499.1-273.2,1124,9.5,1245.7,564
                   ...
                   c14.9-175.8,79.8-331.4,194.8-465.3c62.2-74.4,136.6-135.3,219.1-186.7C491,123.1,496.4,121.7,504.5,117.7L504.5,117.7z" />
                    <g>
                       ...
                       c-12.2,52.8,18.9,86.6,51.4,123.1C1276.9,906.2,1270.1,853.5,1249.8,799.4z" />
                        <path class="st0"
                            d="M1030.7,263.8c2.7,40.6,5.4,75.7,9.5,115c23-25.7,41.9-46,62.2-67.6l4.1,4.1c-8.1,39.2-17.6,79.8-27.1,120.4
                    ...
                    <path class="st1"
                        d="M963,869.7c39.2-29.8,77.1-56.8,123.1-69c9.5-2.7,20.3,1.4,29.8,4.1c6.8,2.7,12.2,6.8,18.9,10.8
                    ...
                    @foreach ($fixtures as $game)
                        ...
                        <a href="{{ \Carbon\Carbon::now()->diffInHours($datetime) < 1 ?  '#' : route('live') . '?li=' . urlencode($encryption) }}"
                            ...
                            {{-- <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">{{$game['datetime']}}</h2>
